...
function(_qt_internal_collect_i18n_targets out_var dir)
    set(result "")
    get_property(excluded DIRECTORY "${dir}" PROPERTY QT_EXCLUDE_FROM_TRANSLATION)
    if(NOT excluded)
        get_property(subdirs DIRECTORY "${dir}" PROPERTY SUBDIRECTORIES)
        foreach(subdir IN LISTS subdirs)
            _qt_internal_collect_i18n_targets(subresult "${subdir}")
...
function(qt6_collect_i18n_targets out_var)
    ...
    _qt_internal_collect_i18n_targets(result "${dir}")
    set("${out_var}" "${result}" PARENT_SCOPE)
endfunction()
...
if(NOT QT_NO_CREATE_VERSIONLESS_FUNCTIONS)
    ...
    function(qt_collect_i18n_targets out_var)
        if(QT_DEFAULT_MAJOR_VERSION EQUAL 6)
            qt6_collect_i18n_targets("${out_var}" ${ARGN})
        else()
            message(FATAL_ERROR "qt_collect_i18n_targets() is only available in Qt 6.")
        endif()
