...
/*!
  ...
  Auto-generated documentation (such as for explicitly defaulted
  or deleted special member functions) is never worth warning
  about, since it's created by QDoc rather than written by an
  author.
 */
