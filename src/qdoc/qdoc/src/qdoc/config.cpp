...
void Config::reset()
{
    ...
    setStringList(CONFIG_SHOWAUTOGENERATEDDOCS, QStringList("true"));
    setStringList(CONFIG_PRELIMINARY, QStringList("Preliminary"));
    setStringList(CONFIG_PRELIMINARY + dot + CONFIG_DESCRIPTION,
                  QStringList("This \1 is under development and is subject to change."));
