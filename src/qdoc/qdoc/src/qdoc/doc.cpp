...
/*!
  Returns true if this documentation was auto-generated by QDoc
  rather than written by an author.
 */
bool Doc::isAutoGenerated() const
{
    return m_priv != nullptr && m_priv->m_autoGenerated;
}
