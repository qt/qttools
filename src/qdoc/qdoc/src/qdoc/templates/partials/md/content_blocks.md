...
| {% for cell in row.cells %}{% if cell.type == "table-cell" %}{% if existsIn(cell, "inlines") %}{% for i in cell.inlines %}{% if i.type == "image" %}{% if existsIn(i, "href") %}![{% if existsIn(i, "title") %}{{ i.title }}{% endif %}]({{ i.href }}){% endif %}{% else if i.type == "link" %}{% if existsIn(i, "href") %}[{% for c in i.children %}{{ escape_md_table(c.text) }}{% endfor %}]({{ i.href }}){% else %}{% for c in i.children %}{{ escape_md_table(c.text) }}{% endfor %}{% endif %}{% else %}{{ escape_md_table(i.text) }}{% endif %}{% endfor %}{% endif %}{% for child in cell.children %}{% if child.type == "list" %}{% for item in child.children %}{% if not loop.is_first %}<br>{% endif %}{% for p in item.children %}{% if p.type == "paragraph" and existsIn(p, "inlines") %}{% for i in p.inlines %}{% if i.type == "image" %}{% if existsIn(i, "href") %}![{% if existsIn(i, "title") %}{{ i.title }}{% endif %}]({{ i.href }}){% endif %}{% else if i.type == "link" %}{% if existsIn(i, "href") %}[{% for c in i.children %}{{ escape_md_table(c.text) }}{% endfor %}]({{ i.href }}){% else %}{% for c in i.children %}{{ escape_md_table(c.text) }}{% endfor %}{% endif %}{% else %}{{ escape_md_table(i.text) }}{% endif %}{% endfor %}{% endif %}{% endfor %}{% endfor %}{% else if child.type == "paragraph" and existsIn(child, "inlines") %}{% for i in child.inlines %}{% if i.type == "image" %}{% if existsIn(i, "href") %}![{% if existsIn(i, "title") %}{{ i.title }}{% endif %}]({{ i.href }}){% endif %}{% else if i.type == "link" %}{% if existsIn(i, "href") %}[{% for c in i.children %}{{ escape_md_table(c.text) }}{% endfor %}]({{ i.href }}){% else %}{% for c in i.children %}{{ escape_md_table(c.text) }}{% endfor %}{% endif %}{% else %}{{ escape_md_table(i.text) }}{% endif %}{% endfor %}{% else %}{{ escape_md_table(child.text) }}{% endif %}{% endfor %}{{ " " }}| {% endif %}{% endfor %}
