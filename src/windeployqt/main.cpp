...
#endif
{
    ...
    QtCore5CompatModule            = 0x0020000000000000,
    QtChartsModule                 = 0x0040000000000000,
    QtDataVisualizationModule      = 0x0080000000000000,
    QtRemoteObjectsModule          = 0x0100000000000000,
    QtScxmlModule                  = 0x0200000000000000,
    QtNetworkAuthorizationModule   = 0x0400000000000000
};
